...
import com.namimono.aop.LogAspect;
import com.namimono.aop.SimplyPointcut;
...
@Configuration
@ComponentScan("com.namimono.aop")
...
//        defaultPointcutAdvisor.setPointcut(new SimplyPointcut());
//        defaultPointcutAdvisor.setAdvice(new MyAopAdvice());
